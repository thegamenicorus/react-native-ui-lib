...
this.props,useSafeArea=_props.useSafeArea,style=_props.style,left=_props.left,top=_props.top,right=_props.right,bottom=_props.bottom,propsFlex=_props.flex,others=_objectWithoutProperties(_props,['useSafeArea','style','left','top','right','bottom','flex']);
var Element=useSafeArea&&Constants.isIOS?_reactNative.SafeAreaView:_reactNative.View;
...
}}]);return View;}(_commons.BaseComponent);View.displayName='View';View.propTypes=_extends({},_reactNative.ViewPropTypes,_commons.BaseComponent.propTypes,{useSafeArea:_propTypes2.default.bool});exports.default=View;
