...
onSelectedLayout=function(){for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}
_lodash2.default.invoke.apply(_lodash2.default,[_this.props,'onSelectedLayout'].concat(args));
};if(props.label){console.warn('PickerItem \'label\' prop will be deprecated soon. please include label in \'value\' prop. (refer docs)');}if(!_lodash2.default.isObject(props.value)){console.warn('PickerItem \'value\' prop type has changed to object, please use it with the following format: {value: ..., label: ...} or use getItemValue & getItemLabel props');}return _this;}_createClass(PickerItem,[{key:'generateStyles',value:function generateStyles(){this.styles=createStyles(this.props);}},{key:'getLabel',value:function getLabel(){var _props=this.props,value=_props.value,label=_props.label;if(_lodash2.default.isObject(value)){return _lodash2.default.invoke(this.props,'getItemLabel',value)||_lodash2.default.get(value,'label');}return label;}},{key:'renderSelectedIndicator',value:function renderSelectedIndicator(){var _props2=this.props,isSelected=_props2.isSelected,disabled=_props2.disabled;if(isSelected){return _react2.default.createElement(_reactNative.Image,{style:[this.styles.checkIcon,disabled&&this.styles.checkIconDisabled],source:_assets2.default.icons.check});}}},{key:'renderItem',value:function renderItem(){var disabled=this.props.disabled;return _react2.default.createElement(_view2.default,{style:this.styles.container,flex:true,row:true,spread:true,centerV:true},_react2.default.createElement(_text2.default,{numberOfLines:1,style:[this.styles.labelText,disabled&&this.styles.labelTextDisabled]},this.getLabel()),this.renderSelectedIndicator());}},{key:'render',value:function render()
