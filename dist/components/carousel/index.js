...
pageIndex){var _this5=this;var animated=arguments.length>1&&arguments[1]!==undefined?arguments[1]:true;
this.setState({
currentPage:pageIndex},
function(){return _this5.updateOffset(animated);});
}}]);return Carousel;}(_commons.BaseComponent);Carousel.displayName='Carousel';Carousel.propTypes={initialPage:_propTypes2.default.number,pageWidth:_propTypes2.default.number,onChangePage:_propTypes2.default.func,containerStyle:_propTypes2.default.oneOfType([_propTypes2.default.object,_propTypes2.default.number,_propTypes2.default.array])};Carousel.defaultProps={initialPage:0,pageWidth:_helpers.Constants.screenWidth};exports.default=Carousel;
