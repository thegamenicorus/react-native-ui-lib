...
_react2.default.createElement(_touchableOpacity2.default,{onPress:onCtaPress},
...
}}]);return StateScreen;}(_commons.BaseComponent);StateScreen.displayName='StateScreen';StateScreen.propTypes={imageSource:_propTypes2.default.oneOfType([_propTypes2.default.object,_propTypes2.default.number]),title:_propTypes2.default.string.isRequired,subtitle:_propTypes2.default.any,ctaLabel:_propTypes2.default.string,onCtaPress:_propTypes2.default.func,testId:_propTypes2.default.string};exports.default=StateScreen;
